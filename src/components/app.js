        ...
        <div className="calculator">
            ...
            <Row>
                <Col xs={12} sm={12} md={12} >
                    <Key style={{width:'75%'}} className="key-function" onClick={() => this.clearDisplay()}>{clearText}</Key>
          ...
          <Row>
           ...
           <Row>
            ...
            <Row>
            <Col xs={12} sm={12} md={12}>    
                <Key style={{width:'75%'}} className="key-0" onClick={() => this.inputDigit(0)}>0</Key>
